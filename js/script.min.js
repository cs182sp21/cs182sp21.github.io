$(document).ready(function(){HOMEPAGE_LIST_PARAM='cs189homepagelists';function State(){data={};this.save=function(){localStorage.setItem(HOMEPAGE_LIST_PARAM,JSON.stringify(data));return this;}
